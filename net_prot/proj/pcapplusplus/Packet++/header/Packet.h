...
namespace pcpp
{
	...
	public:
		...
		std::string toTSVString(bool timeAsLocalTime = true) const;

		void toTSVStringList(std::vector<std::string>& result, bool timeAsLocalTime = true) const;

		std::string toJSONString(bool timeAsLocalTime = true) const;

		void toJSONStringList(std::vector<std::string>& result, bool timeAsLocalTime = true) const;
