...
namespace pcpp
{
	...
	// |	Layer	|	Type	|	Cmd	|
	std::string FtpRequestLayer::toTSVString() const
	{
		return "FTP Layer\tRequest\t" + getCommandString();
	}

	std::string FtpRequestLayer::toJSONString() const
	{
	...
	// |	Layer	|	Type	|	Status	|
	std::string FtpResponseLayer::toTSVString() const
	{
		return "FTP Layer\tResponse\t" + getStatusCodeString();
	}

	std::string FtpResponseLayer::toJSONString() const
	{
		return "{\n\"Layer\": \"FTP Layer\",\n\"Type\": \"Response\",\n\"Status\": \"" + getStatusCodeString() + "\"\n}";
	}
	...
	// |	Layer	|	Type	|
	std::string FtpDataLayer::toTSVString() const
	{
		return "FTP Layer\tData";
	}

	std::string FtpDataLayer::toJSONString() const
	{
		return "{\n\"Layer\": \"FTP Layer\",\n\"Type\": \"Data\"\n}";
	}
