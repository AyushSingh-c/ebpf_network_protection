...
namespace pcpp
{
	...
	std::string WakeOnLanLayer::toTSVString() const
	{
		return "Wake On LAN Layer\t" + getTargetAddr().toString();
	}

	std::string WakeOnLanLayer::toJSONString() const
	{
		return "{\n\"Layer\": \"Wake On LAN Layer\",\n\"Target Address\": \"" + getTargetAddr().toString() + "\"\n}";
	}
