...
namespace pcpp
{
	...
	std::string SmtpRequestLayer::toTSVString() const
	{
		return "SMTP request layer, command: " + getCommandInfo(getCommand());
	}

	std::string SmtpRequestLayer::toJSONString() const
	{
		return "SMTP request layer, command: " + getCommandInfo(getCommand());
	}
	...
	std::string SmtpResponseLayer::toTSVString() const
	{
		return "SMTP response layer, status code: " + getStatusCodeAsString(getStatusCode());
	}

	std::string SmtpResponseLayer::toJSONString() const
	{
		return "SMTP response layer, status code: " + getStatusCodeAsString(getStatusCode());
	}
