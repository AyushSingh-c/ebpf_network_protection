...
namespace pcpp
{
	...
	std::string AuthenticationHeaderLayer::toTSVString() const
	{
		return "Authentication Header Layer";
	}

	std::string AuthenticationHeaderLayer::toJSONString() const
	{
		return "Authentication Header Layer";
	}
	...
	std::string ESPLayer::toTSVString() const
	{
		std::ostringstream stream;
		stream << "ESP Layer, SPI: 0x" << std::hex << getSPI();
		return stream.str();
	...
	std::string ESPLayer::toJSONString() const
	{
		std::ostringstream stream;
		stream << "ESP Layer, SPI: 0x" << std::hex << getSPI();
		return stream.str();
