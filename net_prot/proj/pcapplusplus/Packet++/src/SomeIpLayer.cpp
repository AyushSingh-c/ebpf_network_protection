...
namespace pcpp
{
	...
	std::string SomeIpLayer::toTSVString() const
	{
		std::stringstream dataStream;
	...
	std::string SomeIpLayer::toJSONString() const
	{
		std::stringstream dataStream;
	...
	std::string SomeIpTpLayer::toTSVString() const
	{
		std::stringstream dataStream;
	...
	std::string SomeIpTpLayer::toJSONString() const
	{
		std::stringstream dataStream;
