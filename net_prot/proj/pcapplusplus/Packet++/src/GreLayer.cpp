...
namespace pcpp
{
	...
	// |	Layer	|	Version	|
	std::string GREv0Layer::toTSVString() const
	{
		return "GRE Layer\t0";
	}

	std::string GREv0Layer::toJSONString() const
	{
		return "{\n\"Layer\": \"GRE Layer\",\n\"Version\": \"0\"\n}";
	}
	...
	// |	Layer	|	Version	|
	std::string GREv1Layer::toTSVString() const
	{
		return "GRE Layer\t1";
	}

	std::string GREv1Layer::toJSONString() const
	{
		return "{\n\"Layer\": \"GRE Layer\",\n\"Version\": \"1\"\n}";
	}
