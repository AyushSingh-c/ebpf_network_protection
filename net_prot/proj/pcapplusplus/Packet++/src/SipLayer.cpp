...
namespace pcpp
{
	...
	std::string SipRequestLayer::toTSVString() const
	{
		static const int maxLengthToPrint = 120;
		std::string result = "SIP request, ";
		int size = m_FirstLine->getSize() - 2;  // the -2 is to remove \r\n at the end of the first line
	...
	std::string SipRequestLayer::toJSONString() const
	{
		static const int maxLengthToPrint = 120;
		std::string result = "SIP request, ";
		int size = m_FirstLine->getSize() - 2;  // the -2 is to remove \r\n at the end of the first line
	...
	std::string SipResponseLayer::toTSVString() const
	{
		static const int maxLengthToPrint = 120;
		std::string result = "SIP response, ";
		int size = m_FirstLine->getSize() - 2;  // the -2 is to remove \r\n at the end of the first line
	...
	std::string SipResponseLayer::toJSONString() const
	{
		static const int maxLengthToPrint = 120;
		std::string result = "SIP response, ";
		int size = m_FirstLine->getSize() - 2;  // the -2 is to remove \r\n at the end of the first line
