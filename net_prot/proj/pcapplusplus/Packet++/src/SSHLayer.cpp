...
#define SSH_LAYER_BASE_STRING "SSH Layer"
	...
	std::string SSHIdentificationMessage::toTSVString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Identification message";
	}

	std::string SSHIdentificationMessage::toJSONString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Identification message";
	}
	...
	std::string SSHHandshakeMessage::toTSVString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Handshake Message: " + getMessageTypeStr();
	}

	std::string SSHHandshakeMessage::toJSONString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Handshake Message: " + getMessageTypeStr();
	}
	...
	std::string SSHEncryptedMessage::toTSVString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Encrypted Message";
	}

	std::string SSHEncryptedMessage::toJSONString() const
	{
		return std::string(SSH_LAYER_BASE_STRING) + ", " + "Encrypted Message";
	}
