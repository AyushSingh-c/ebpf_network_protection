...
namespace pcpp
{
	...
	std::string SSLHandshakeLayer::toTSVString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, Handshake:";
		for (size_t i = 0; i < m_MessageList.size(); i++)
	...
	std::string SSLHandshakeLayer::toJSONString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, Handshake:";
		for (size_t i = 0; i < m_MessageList.size(); i++)
	...
	std::string SSLChangeCipherSpecLayer::toTSVString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, Change Cipher Spec";
		return result.str();
	...
	std::string SSLChangeCipherSpecLayer::toJSONString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, Change Cipher Spec";
		return result.str();
	...
	std::string SSLAlertLayer::toTSVString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, ";
		if (getAlertLevel() == SSL_ALERT_LEVEL_ENCRYPTED)
	...
	std::string SSLAlertLayer::toJSONString() const
	{
		std::stringstream result;
		result << getRecordVersion().toString(true) << " Layer, ";
		if (getAlertLevel() == SSL_ALERT_LEVEL_ENCRYPTED)
	...
	std::string SSLApplicationDataLayer::toTSVString() const
	{
		return getRecordVersion().toString(true) + " Layer, Application Data";
	}

	std::string SSLApplicationDataLayer::toJSONString() const
	{
		return getRecordVersion().toString(true) + " Layer, Application Data";
	}
